        ...
        <figure className="portfolioItem">
          ...
          <figcaption className="right">
            <div className="portfolioDescription">
              ...
              <p>
                A digitization of the ROM’s 2016-2017 Annual Report, I took on this project from another employee and finessed the design and development of this project. Built with PHP.
              </p>
            </div>
        ...
        <figure className="portfolioItem">
          ...
          <figcaption className="left">
            <div className="portfolioDescription">
              ...
              <p>
                Built on Drupal and utilizing vanilla JavaScript and PHP, this microsite was the primary digital marketing tool for the Wildlife Photographer of the Year 2017 exhibit at the ROM. I was responsible for development and created the design based on a pre-existing exhibition microsite template.
              </p>
            </div>
            <ul className="skillList">
              <li>JavaScript</li>
        ...
        <figure className="portfolioItem">
          ...
          <figcaption className="right">
            <div className="portfolioDescription">
              ...
              <p>
                A digital laundry helper providing explanations for the icons on your clothing tags, this project is built using React, React Router, and Firebase. It also uses the Google Maps JavaScript API and the Google Places API to locate nearby laundromats. I designed and coded everything myself, although the laundry advice is mostly from my mother.
              </p>
            </div>
            <ul className="skillList">
              <li>React</li>
        ...
        <figure className="portfolioItem">
          ...
          <figcaption className="right">
            <div className="portfolioDescription">
              <h3>Herd of Words</h3>
              <p>
                This jQuery-written cow-themed lorem ipsum generator, this was a project created just-for-fun with Kitty Yau where we each worked on the design, development, and the giant list of cow words.
              </p>
            </div>
            <ul className="skillList">
              <li>JavaScript</li>
